...
from peaknet.utils_fsdp                    import save_checkpoint, load_checkpoint
...
# [[[ FSDP POLICY ]]]
# Define a sized based wrap policy where layers with more than min_num_params will be sharded...
min_num_params = 2e4
...
if uses_fsdp:
    ...
    model = FSDP(model, device_ids = [fsdp_local_rank])
